...
public:
    ...
    void run() {
        while (true) {
            ...
            pthread_t tid;
            pthread_create(&tid, NULL, &FTPServer::handleClient, (void*)new int(client_socket)); // Pass the client socket
            pthread_detach(tid); // Automatically clean up when thread finishes
        }
    }
...
private:
    ...
    static void* handleClient(void* arg) {
        ...
        delete (int*)arg; // Clean up the dynamically allocated socket pointer
